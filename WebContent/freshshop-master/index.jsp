			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.jsp"><img
						src="<%=request.getContextPath()%>/freshshop-master/images/logo2.png"
						class="logo" alt=""></a>
				</div>
					...
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown"
						...
						<li class="dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								<li><a href="<%=request.getContextPath()%>/ProductServlet?command=product_List">상품 목록</a></li>
			...
			<li class="text-center"><img
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20">
								<strong>Welcome To <br> Fresh Market
								</strong>
							</h1>
							<p class="m-b-40">
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-4 col-xl-4">
					<div class="blog-box">
						<div class="blog-img">
							<img
								class="<%=request.getContextPath()%>/freshshop-master/img-fluid"
								src="images/blog-img-02.jpg" alt="" />
						</div>
						<div class="blog-content">
							<div class="title-blog">
								<h3>Fusce in augue non nisi fringilla</h3>
