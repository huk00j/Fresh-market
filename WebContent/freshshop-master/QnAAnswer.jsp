            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form class="Answer" name="Answer" action="<%=request.getContextPath()%>/QnAServlet?command=QnA_Answer_Reply" method="post">
                           <input type="hidden" name="questionNo" value="${qdto.no}">
                           <input type="hidden" name="questionId" value="${qdto.id}">
                           <input type="hidden" name="questionTitle" value="${qdto.title }">
                           <input type="hidden" name="questionContent" value="${qdto.content }">
                           
                            <div class="row">
                                
                                <c:set var="qdto" value="${qdto }"></c:set>
                                
                                <div class="col-md-12">
									<%-- 이름 --%>
									<div class="form-group">
										<label for="exampleFormControlSelect1">제목</label> <input
											type="text" class="form-control" id="enrollname" name="questionTitle"
											placeholder="${qdto.title }" value="re: ${qdto.title }" required disabled
                                    ...
                                    <div class="form-group">
										<label>원글 내용</label>
										<textarea class="form-control" id="message" name="questionContent"
											placeholder="${qdto.content }" rows="4"
											data-error="Write your message" required disabled>${qdto.content }</textarea>
										<div class="help-block with-errors"></div>
									</div>
                                    
                                    <div class="form-group">
										<label>답변 내용</label>
										<textarea class="form-control" id="message" name="AnswerContent"
