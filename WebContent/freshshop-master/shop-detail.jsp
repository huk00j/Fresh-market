            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="<%=request.getContextPath()%>/upload/${pdto.image}" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="<%=request.getContextPath()%>/freshshop-master/images/big-img-02.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="<%=request.getContextPath()%>/freshshop-master/images/big-img-03.jpg" alt="Third slide"> </div>
                        </div>
                        <a class="carousel-control-prev" href="<%=request.getContextPath()%>/freshshop-master/#carousel-example-1" role="button" data-slide="prev"> 
						<i class="fa fa-angle-left" aria-hidden="true"></i>
						<span class="sr-only">Previous</span> 
					</a>
                        <a class="carousel-control-next" href="<%=request.getContextPath()%>/freshshop-master/#carousel-example-1" role="button" data-slide="next"> 
						<i class="fa fa-angle-right" aria-hidden="true"></i> 
						<span class="sr-only">Next</span> 
					</a>
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src="<%=request.getContextPath()%>/upload/${pdto.image}" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="1">
                                <img class="d-block w-100 img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/smp-img-02.jpg" alt="" />
                            </li>
                            <li data-target="#carousel-example-1" data-slide-to="2">
                                <img class="d-block w-100 img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/smp-img-03.jpg" alt="" />
                            </li>
                        </ol>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                    	...
                    	<form name="add_Cart_Detail" method="post" action="GuestServlet?command=add_cart_action">
                    	<input type="hidden" name="pId" value="${sessionScope.sid}">
                    	<input type="hidden" name="pNum" value="${pdto.num }">
                    	
                        <h2>${pdto.name }</h2>
                        <input type="hidden" name="pName" value="${pdto.name }">
                        <h5> <del>$ 60.00</del> $ ${pdto.price }</h5>
                        <input type="hidden" name="pPrice" value="${pdto.price }">
                        <p class="available-stock"><span> 판매 수량 / <a href="<%=request.getContextPath()%>/freshshop-master/#">${pdto.amount } </a></span><p>
						<h4>원산지 </h4>
						<p>${pdto.origin }. </p>
						...
						<ul>
							<li>
								<div class="form-group quantity-box">
									...
									<input class="form-control" value="1" min="1" max="20" type="number" name="pAmount">
								</div>
							</li>
						</ul>
						...
						<div class="price-box-bar">
							...
							<c:choose>
								<c:when test="${sessionScope.sid != null}">
									<a class="btn hvr-hover" data-fancybox-close="" href="<%=request.getContextPath()%>/freshshop-master/#">Buy New</a>
									<a class="btn hvr-hover" data-fancybox-close="" href="javascript:document.add_Cart_Detail.submit();">장바구니 담기</a>
									<%-- 새로 form 만들어서 사용할 때 안 되면 이거 참고. --%>
								</c:when>

								<c:otherwise>
									<c:if test="${sessionScope.sid == null}">
										<a class="btn hvr-hover" data-fancybox-close="" href="<%=request.getContextPath()%>/login/login.jsp">Buy New</a>
										<a class="btn hvr-hover" data-fancybox-close="" href="<%=request.getContextPath()%>/login/login.jsp">장바구니 담기</a>
									</c:if>
								</c:otherwise>
							</c:choose>
						...
						<div class="add-to-btn">
							<div class="add-comp">
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/freshshop-master/#"><i class="fas fa-heart"></i> Add to wishlist</a>
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/freshshop-master/#"><i class="fas fa-sync-alt"></i> Add to Compare</a>
							</div>
							<div class="share-bar">
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/freshshop-master/#"><i class="fab fa-facebook" aria-hidden="true"></i></a>
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/freshshop-master/#"><i class="fab fa-google-plus" aria-hidden="true"></i></a>
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/freshshop-master/#"><i class="fab fa-twitter" aria-hidden="true"></i></a>
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/freshshop-master/#"><i class="fab fa-pinterest-p" aria-hidden="true"></i></a>
								<a class="btn hvr-hover" href="<%=request.getContextPath()%>/freshshop-master/#"><i class="fab fa-whatsapp" aria-hidden="true"></i></a>
							</div>
						</div>
			...
			<div class="row my-5">
				<div class="card card-outline-secondary my-4">
					...
					<div class="card-body">
						...
						<a href="<%=request.getContextPath()%>/freshshop-master/#" class="btn hvr-hover">Leave a Review</a>
					</div>
				  </div>
			</div>
