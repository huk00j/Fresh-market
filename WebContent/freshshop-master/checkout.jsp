        ...
        <div class="container">
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a data-toggle="collapse" href="<%=request.getContextPath()%>/freshshop-master/#formLogin" role="button" aria-expanded="false">Click here to Login</a></h5>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <h5><a data-toggle="collapse" href="<%=request.getContextPath()%>/freshshop-master/#formRegister" role="button" aria-expanded="false">Click here to Register</a></h5>
            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="payment-icon">
                                        <ul>
                                            <li><img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/payment-icon/1.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/payment-icon/2.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/payment-icon/3.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/payment-icon/5.png" alt=""></li>
                                            <li><img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/payment-icon/7.png" alt=""></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                            ...
                            <div class="odr-box">
                                ...
                                <div class="rounded p-2 bg-light">
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="<%=request.getContextPath()%>/freshshop-master/detail.html"> Lorem ipsum dolor sit amet</a>
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="<%=request.getContextPath()%>/freshshop-master/checkout.html" class="ml-auto btn hvr-hover">Place Order</a> </div>
                    </div>
                </div>
            </div>
