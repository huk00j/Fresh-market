    ...
    <!-- Start Shop Detail  -->
        <div class="container">
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="order-box">
                            	<div class="title-left"></div>  <!-- 검은색 굵은 줄 -->
                             ...
                             <c:choose>
								<c:when test="${dto.lvl == '1'}">
                                    <div class="font-weight-bold">작성자   ${dto.id }</div>
								</c:when>
                                	<c:otherwise>
                                	<div class="font-weight-bold">작성자   관리자</div>
								</c:otherwise>
							</c:choose>   
                                   
                                    <div class="ml-auto font-weight-bold"> 작성일   ${dto.qnadate }</div>
                                    <div class="ml-auto font-weight-bold"> 조회수   ${dto.views} </div>
                                </div>
               ...
               <%--      
                     	<c:if test="${dto.lvl != '1'}">
                     		...
                     		<div class="order-box">
                                ...
                                <div class="d-flex">
                                    <div class="font-weight-bold">작성자 관리자</div>
                                    <div class="ml-auto font-weight-bold">답변일   ${dto.qnadate }</div>
                                </div>
                                <hr>
               ...
               --%>
                     <!-- ---------------------------------------------------- -->
                      	 ...
                      	 <div class="col-12 d-flex shopping-box"> <a href="<%=request.getContextPath()%>/QnAServlet?command=QnA_List" class="ml-auto btn hvr-hover">목록</a> </div>
