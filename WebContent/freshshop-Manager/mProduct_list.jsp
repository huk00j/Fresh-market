...
<body>
		...
		<nav
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand"
						href="<%=request.getContextPath()%>/freshshop-master/index.html"><img
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown"
						...
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/freshshop-master/index.jsp">Home</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/freshshop-master/about.jsp">About
								Us</a></li>
			<%--
						<li class="dropdown active"><a
							...
							<ul class="dropdown-menu">
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/shop.html">Sidebar
										Shop</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/shop-detail.html">Shop
										Detail</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/cart.html">Cart</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/checkout.html">Checkout</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/my-account.html">My
										Account</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/wishlist.html">Wishlist</a></li>
							</ul></li>
			 --%>				
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="dropdown active"><a class="nav-link dropdown-toggle arrow" data-toggle="dropdown">SHOP</a>
								<ul class="dropdown-menu">
			...
			<div class="side">
				<a href="<%=request.getContextPath()%>/freshshop-master/#"
					class="close-side"><i class="fa fa-times"></i></a>
				<li class="cart-box">
					<ul class="cart-list">
						<li><a
							href="<%=request.getContextPath()%>/freshshop-master/#"
							...
							<h6>
								<a href="<%=request.getContextPath()%>/freshshop-master/#">Delica
									omtantur </a>
							</h6>
							<p>
						...
						<li><a
							...
							class="photo"><img
								...
								class="cart-thumb" alt="" /></a>
							<h6>
								<a href="<%=request.getContextPath()%>/freshshop-master/#">Omnes
									ocurreret</a>
							</h6>
							<p>
						...
						<li><a
							...
							class="photo"><img
								...
								class="cart-thumb" alt="" /></a>
							<h6>
								<a href="<%=request.getContextPath()%>/freshshop-master/#">Agam
									facilisis</a>
							</h6>
							<p>
				...
				<div class="col-lg-12">
					...
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a
							href="<%=request.getContextPath()%>/freshshop-master/#">Home</a></li>
						<li class="breadcrumb-item active">Product lsit</li>
					</ul>
				</div>
			</div>
		</div>
								...
								<c:forEach items="${productList}" var="plist">
									...
									<tr>
										...
										<td class="thumbnail-img"><a
											href="<%=request.getContextPath()%>/freshshop-master/#">
												<img class="img-fluid"
												src="./upload/${plist.image}"
												alt="" />
										</a></td>

										<td class="name-pr"><a
											href="<%=request.getContextPath()%>/freshshop-master/#">${plist.type}</a>
										</td>
										...
										<td class="quantity-box">${plist.origin }</td>
										
										<td class="add-pr"><a class="btn hvr-hover"
											href="<%=request.getContextPath()%>/ManagerServlet?command=modify_select_action&selModNum=${plist.num}">modify</a>
										</td>
										
										<td class="remove-pr"><a href="<%=request.getContextPath()%>/ManagerServlet?command=delete_action&productNum=${plist.num}">
									<%--		<input type="hidden" name="productNum" value="${plist.num}">  --%>
			...
			<div class="item">
				<div class="ins-inner-box">
					<img
						...
						alt="" />
					<div class="hov-in">
						<a href="<%=request.getContextPath()%>/freshshop-master/#"><i
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-top-box">
							...
							<ul>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/#"><i
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-link">
							...
							<ul>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/#">About
										Us</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/#">Customer
										Service</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/#">Our
										Sitemap</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/#">Terms
										&amp; Conditions</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/#">Privacy
										Policy</a></li>
								<li><a
									href="<%=request.getContextPath()%>/freshshop-master/#">Delivery
										Information</a></li>
							</ul>
						</div>
					</div>
								...
								<li>
									<p>
										<i class="fas fa-phone-square"></i>Phone: <a
											href="<%=request.getContextPath()%>/freshshop-master/tel:+1-888705770">+1-888
											705 770</a>
									</p>
								</li>
								<li>
									<p>
										<i class="fas fa-envelope"></i>Email: <a
											href="<%=request.getContextPath()%>/freshshop-master/mailto:contactinfo@gmail.com">contactinfo@gmail.com</a>
									</p>
								</li>
							</ul>
						</div>
	...
	<div class="footer-copyright">
		<p class="footer-company">
			All Rights Reserved. &copy; 2018 <a
				href="<%=request.getContextPath()%>/freshshop-master/#">ThewayShop</a>
			Design By : <a
				href="<%=request.getContextPath()%>/freshshop-master/https://html.design/">html
				design</a>
		</p>
	</div>
	<!-- End copyright  -->
	...
	<a href="<%=request.getContextPath()%>/freshshop-master/#"
		id="back-to-top" title="Back to top" style="display: none;">&uarr;</a>
