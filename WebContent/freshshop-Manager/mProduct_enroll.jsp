        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                 ...
                 <%--       <form id="contactForm">  --%>
                  			<form class="product_form" name="product_form" action="<%=request.getContextPath()%>/ManagerServlet?command=enroll_action" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>품목</label>
										<select class="form-control" id="exampleFormControlSelect1" name="enrolltype" 
								...
								<div class="col-md-12">
									...
									<div class="form-group">
										<label for="exampleFormControlSelect1">이름</label> <input
											type="text" class="form-control" id="enrollname" name="enrollname"
								...
								<div class="col-md-12">
									<div class="form-group">
										<label for="exampleFormControlSelect1">수량</label> <input
											...
											class="form-control" name="enrollamount" required
								...
								<div class="col-md-12">
									<div class="form-group">
										<label for="exampleFormControlSelect1">가격</label> <input
											...
											class="form-control" name="enrollprice" required
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<select class="form-control" id="exampleFormControlSelect1"
											name="enrollorigin" required data-error="Please enter your price">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>상세 설명</label>
										<textarea class="form-control" id="message" name="enrollintroduce"
									...
									<div class="form-group">
										...
										<input type="file" class="form-control-file"
											id="exampleFormControlFile1" name="enrollfile" required>
									</div>
