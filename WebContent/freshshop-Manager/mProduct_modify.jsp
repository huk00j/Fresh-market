            ...
            <div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
						...
						<li class="nav-item"><a class="nav-link"
							href="<%=request.getContextPath()%>/freshshop-master/about.jsp">About Us</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Product Modify </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                 ...
                 <%--       <form id="contactForm">  --%>
                  			<form class="product_form" name="product_form" action="<%=request.getContextPath()%>/ManagerServlet?command=modify_action" enctype="multipart/form-data" method="post">
                 				<input type = "hidden" name="modNum" value="${num }">
                 <%--            <input type="hidden" name="command" value="enroll_action">	--%>
                            <div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>품목</label>
										<select class="form-control" id="exampleFormControlSelect1" name="modifytype" 
								...
								<div class="col-md-12">
									...
									<div class="form-group">
										<label for="exampleFormControlSelect1">이름</label> <input
											type="text" class="form-control" id="enrollname" name="modifyname"
								...
								<div class="col-md-12">
									<div class="form-group">
										<label for="exampleFormControlSelect1">수량</label> <input
											...
											class="form-control" name="modifyamount" required
											value=${amount }
								...
								<div class="col-md-12">
									<div class="form-group">
										<label for="exampleFormControlSelect1">가격</label> <input
											...
											class="form-control" name="modifyprice" required
											value=${price }
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<select class="form-control" id="exampleFormControlSelect1"
											name="modifyorigin" required data-error="Please enter your price">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>상세 설명</label>
										<textarea class="form-control" id="message" name="modifyintroduce"
											placeholder="Your Message" rows="4"
											data-error="Write your message" required>${introduce }</textarea>
										<div class="help-block with-errors"></div>
									</div>
									...
									<div class="form-group">
										...
										<input type="file" class="form-control-file"
											id="exampleFormControlFile1" name="modifyfile" required>
