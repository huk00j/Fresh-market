    ...
    <div class="cart-box-main">
        <div class="container">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
									...
									<img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/img-pro-01.jpg" alt="" />
								</a>
                                    </td>
                                ...
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="<%=request.getContextPath()%>/freshshop-master/#">
									<img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/img-pro-02.jpg" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="<%=request.getContextPath()%>/freshshop-master/#">
                                ...
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="<%=request.getContextPath()%>/freshshop-master/#">
									<img class="img-fluid" src="<%=request.getContextPath()%>/freshshop-master/images/img-pro-03.jpg" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="<%=request.getContextPath()%>/freshshop-master/#">
            ...
            <div class="row my-5">
                ...
                <div class="col-12 d-flex shopping-box"><a href="<%=request.getContextPath()%>/freshshop-master/checkout.html" class="ml-auto btn hvr-hover">Checkout</a> </div>
            </div>
