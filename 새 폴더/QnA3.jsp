        ...
        <div class="container">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="order-box">
                                ...
                                <div class="title-left">
                                    <h2>작성 글 제목을 여기에 넣어주세요.</h2>
                                </div>
                               
                                <div class="d-flex">
                                    <div class="font-weight-bold">작성자 홍길동</div>
                                    <div class="ml-auto font-weight-bold"> 작성일  12/34/56</div>
                                    <div class="ml-auto font-weight-bold"> 조회수 1234 </div>
                                </div>
                    ...
                    <!-- 답변이 없을 경우 여기 주석부터 다음 주석까지 삭제하면 원글 폼만 보입니다. -->        
                            <div class="order-box">
                                ...
                                <div class="d-flex">
                                    <div class="font-weight-bold">작성자 고길동</div>
                    ...
                    <!-- 원글만 보고싶을 경우 여기까지 삭제  ----------------------------------- -->    
                      	 ...
                      	 <div class="col-12 d-flex shopping-box"> <a href="checkout.html" class="ml-auto btn hvr-hover">목록</a> </div>
